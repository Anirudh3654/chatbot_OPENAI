...
"""
This is the class where all the functions for the chat bot are defined.
"""
class VoiceAssistant:
    ...
    def listen(self):
        ...
        print("Listening...")
        # Record the audio
        dur = 3  # Record for 3 seconds
        fs = 44100  # Sample rate

        audio = sd.rec(int(dur * fs), samplerate=fs, channels=1, dtype=np.int16)
        sd.wait()
